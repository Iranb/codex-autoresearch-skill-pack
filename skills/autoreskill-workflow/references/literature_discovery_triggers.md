...
| `experiment` | an accepted scientific outcome contradicts the expected mechanism, exposes a confound, or leaves a concrete replacement/scoping question that current evidence cannot answer | targeted mechanism/negative evidence routed to the decision ledger; operational failures do not trigger broad literature search |
