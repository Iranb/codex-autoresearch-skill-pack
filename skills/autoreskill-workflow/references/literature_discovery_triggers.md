...
- Do not treat `fastCommitted` alone as evidence closure. If `authoritativeSync` is pending, queue an async monitor based on `import_workflow` progress and wait for the selected task ids.
