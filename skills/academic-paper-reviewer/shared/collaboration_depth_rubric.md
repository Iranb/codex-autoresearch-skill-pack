...
**Canonical location**: `shared/collaboration_depth_rubric.md` in `example/academic-research-skills`. External consumers should reference by stable URL; do not vendor (bump the `rubric_version` field on any modification).
